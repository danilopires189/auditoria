...
echo • DB_TERMO, DB_PEDIDO_DIRETO, DB_ESTQ_ENTR, DB_BLITZ (1h)
echo • BD_END (6h)
echo • DB_BARRAS, BD_AVULSO, BD_ROTAS, DB_LOG_END, DB_USUARIO, DB_PROD_VOL, DB_GESTAO_ESTQ, DB_TRANSF_CD (1x/dia)
echo.
