...
echo • 1 HORA: DB_ATENDIMENTO, DB_TERMO, DB_PEDIDO_DIRETO, DB_PROD_BLITZ, DB_ESTQ_ENTR  
echo • 6 HORAS: BD_END
echo • 1x POR DIA: DB_BARRAS, BD_AVULSO, BD_ROTAS, DB_LOG_END, DB_USUARIO, DB_PROD_VOL, DB_GESTAO_ESTQ
echo ==========================================
echo.
