...
begin
    ...
    -- Primeiro tenta casar pelo mesmo "ref" da base (chave, ou NFD quando chave ausente).
    select
    ...
    -- Fallback por NFD numérico. Se houver múltiplos refs para a mesma NFD, exige chave.
