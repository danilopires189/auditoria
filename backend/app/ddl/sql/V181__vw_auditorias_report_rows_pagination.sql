drop function if exists public.rpc_vw_auditorias_report_rows(date, date, integer, integer);
...
grant execute on function public.rpc_vw_auditorias_report_rows(date, date, integer, integer, integer) to authenticated;
