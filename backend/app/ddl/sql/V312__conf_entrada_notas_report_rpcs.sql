drop function if exists public.rpc_conf_entrada_notas_report_count(date, date, integer);
...
drop function if exists public.rpc_conf_entrada_notas_report_rows(date, date, integer, integer, integer);
...
drop function if exists public.rpc_conf_entrada_notas_report_contributors(date, date, integer);
...
grant execute on function public.rpc_conf_entrada_notas_report_count(date, date, integer) to authenticated;
grant execute on function public.rpc_conf_entrada_notas_report_rows(date, date, integer, integer, integer) to authenticated;
grant execute on function public.rpc_conf_entrada_notas_report_contributors(date, date, integer) to authenticated;
