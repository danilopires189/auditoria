-- Allow users from CDs 10 and 11 to switch between both CDs using the app selector.
...
begin
    ...
    if coalesce(array_length(v_cds, 1), 0) > 0 and (10 = any(v_cds) or 11 = any(v_cds)) then
