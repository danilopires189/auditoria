create index if not exists idx_app_db_entrada_notas_cd_dh_consistida_today
    on app.db_entrada_notas(cd, dh_consistida desc, seq_entrada desc, coddv)
...
begin
    ...
    where t.cd = v_cd
      ...
      and (t.dh_consistida at time zone 'America/Sao_Paulo')::date = v_today
