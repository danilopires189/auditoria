...
echo       • 1x/dia: DB_BARRAS, BD_AVULSO, BD_ROTAS, DB_LOG_END, DB_USUARIO, DB_PROD_VOL
echo       • 6h: BD_END
...
echo - Arquivos estáticos (1x/dia): DB_BARRAS, BD_AVULSO, BD_ROTAS, DB_LOG_END, DB_USUARIO, DB_PROD_VOL
echo.
...
echo Pressione qualquer tecla para fechar...
pause >nulecho - 
Monitor dedicado (5min): DB_DEVOLUCAO
