...
function mapItemRow(raw: Record<string, unknown>): GestaoEstoqueItemRow {
  return {
    ...
    last_quantity_before: parseNullableInteger(raw.last_quantity_before),
    last_quantity_after: parseNullableInteger(raw.last_quantity_after),
    last_quantity_change_at: parseNullableString(raw.last_quantity_change_at),
