...
export interface ProdutividadeRankingRow {
  ...
  atividade_extra_qtd: number;
  alocacao_pontos: number;
  alocacao_qtd: number;
  devolucao_pontos: number;
  devolucao_qtd: number;
  conf_termo_pontos: number;
  ...
  conf_transferencia_cd_qtd: number;
  conf_lojas_pontos: number;
  conf_lojas_qtd: number;
  aud_caixa_pontos: number;
  aud_caixa_qtd: number;
  caixa_termica_pontos: number;
  caixa_termica_qtd: number;
