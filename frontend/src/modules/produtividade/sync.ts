...
function mapRankingRow(raw: Record<string, unknown>): ProdutividadeRankingRow {
  return {
    ...
    coleta_pontos: parseNumber(raw.coleta_pontos),
    coleta_qtd: parseNumber(raw.coleta_qtd),
    ...
    pedido_direto_pontos: parseNumber(raw.pedido_direto_pontos),
    pedido_direto_qtd: parseNumber(raw.pedido_direto_qtd),
    ...
    caixa_termica_pontos: parseNumber(raw.caixa_termica_pontos),
    caixa_termica_qtd: parseNumber(raw.caixa_termica_qtd),
